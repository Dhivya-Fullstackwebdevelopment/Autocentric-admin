// DeleteAppointmentBookingPopup.tsx
import React, { useState } from 'react';
import { IoCloseCircle } from 'react-icons/io5';
import { apiAxios } from '../../commonapicall/api/apiUrl';

interface DeleteServicedetailsProps {
    closePopup: () => void;
    servicedetailsId: number;
    refreshData?: () => void; // Made optional since we'll implement it later
}

export const DeleteServicedetailsPopup: React.FC<DeleteServicedetailsProps> = ({
    closePopup,
    servicedetailsId,
    refreshData
}) => {
    ...
    const handleDelete = async () => {
        ...
        try {
            // TODO: Replace with actual appointment deletion API call
            // await DeleteAppointmentBooking(appointmentId);
            const response = await apiAxios.delete(`/api/service-details/delete/${servicedetailsId}/`);
            console.log(response);
            if (refreshData) {
                refreshData(); // Refresh the appointment list
            }
            ...
            <div className="container mx-auto">
                <div className="relative bg-white rounded-[5px] w-4/12 mx-auto px-5 py-5">
                    <div className="relative mb-10">
                        <h2 className="text-2xl text-black font-semibold pb-3 border-b-2 border-gray-100 ">Delete Invoice</h2>
