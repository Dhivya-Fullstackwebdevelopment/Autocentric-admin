...
// import { createCustomerInfo } from "../../commonapicall/CutomerInfoapis/CutomerInfoapis";
...
//                         <h2 className="text-2xl font-bold">Add Customer Information</h2>
...
const customerSchema = zod.object({
    ...
    email: zod
        ...
        .min(3, "Email is required")
        .regex(/^[^\s@]+@[^\s@]+\.[^\s@]+$/, "Invalid email format"),
    postal_code: zod.string().min(3, "Postal Code is required"),
    home_address: zod.string()
        .min(3, "Address is required"),
    date: zod.string().optional()
});
