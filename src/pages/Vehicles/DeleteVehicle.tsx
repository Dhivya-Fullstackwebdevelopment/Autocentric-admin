...
import { DeleteVehicleList } from '../../commonapicall/Vehiclesapis/Vehiclesapis';


interface DeleteVehiclePopupProps {
    closePopup: () => void;
    VehicleId: number; // Add customerId to identify which customer to delete
    refreshData: () => void; // Add refreshData to update the list after deletion
}

export const DeleteVehicle: React.FC<DeleteVehiclePopupProps> = ({
    closePopup,
    VehicleId,
    refreshData,
}) => {
    ...
    const handleDelete = async () => {
        ...
        try {
            await DeleteVehicleList(VehicleId);
            ...
            <div className="container mx-auto">
                <div className="relative bg-white rounded-[5px] w-4/12 mx-auto px-5 py-5">
                    <div className="relative mb-10">
                        <h2 className="text-2xl text-black font-semibold pb-3 border-b-2 border-gray-100 ">Delete Vehicle</h2>
