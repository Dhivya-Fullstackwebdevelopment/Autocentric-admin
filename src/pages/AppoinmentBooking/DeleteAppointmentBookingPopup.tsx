...
interface DeleteAppointmentBookingPopupProps {
    onClose: () => void;
    appointmentId: number;
    refreshData?: () => void; // Made optional since we'll implement it later
}

export const DeleteAppointmentBookingPopup: React.FC<DeleteAppointmentBookingPopupProps> = ({
    onClose,
    appointmentId,
    refreshData
}) => {
    ...
    const handleDelete = async () => {
        ...
        try {
            const response = await apiAxios.delete(`/api/appointments/delete/${appointmentId}/`);
            ...
            <div className="container mx-auto">
                <div className="relative bg-white rounded-[5px] w-4/12 mx-auto px-5 py-5">
                    <div className="relative mb-10">
                        <h2 className="text-2xl text-black font-semibold pb-3 border-b-2 border-gray-100 ">Delete Booking & Invoice</h2>
