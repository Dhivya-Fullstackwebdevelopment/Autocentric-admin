...
// // //   }).nonempty("Car registration is required"),
// // //   date: z.string({
...
// // // export const EditAppointmentBookingPage: React.FC<EditAppointmentBookingPopupProps> = ({ closePopup }) => {
...
// // //     services.filter(s => s.serviceId !== undefined).map(s => s.serviceId),
// // //   [services]);
...
// // //           details: service.name || service.service_name,
...
// // //         setActualTotal(calculateActualTotal(initialServices, includeVAT));

// // //         reset({
// // //           car: data.car_reg || data.car,
// // //           date: data.date.split('T')[0],
// // //           time: data.time,
// // //           customerName: data.customer_name,
// // //           services: initialServices.map((service: { serviceId: any; details: any; price: any; }) => ({
...
// // //   const handleServiceSelection = (index: number, masterService: Service | null) => {
...
// // //         setDeleteError("At least one service is required.");
// // //         setIsLoading(false);
// // //         return;
// // //       }
...
// // //       const response = await apiAxios.patch(`/api/appointments/${id}/`, payload);
...
// // //           <div className="h-[220px] overflow-y-auto bg-white rounded mb-6 border border-gray-200">
...
// // //                                     }}
// // //                                   >
// // //                                     {masterService.name || masterService.service_name}
// // //                                   </div>
// // //                                 )
// // //                               )}
// // //                             </div>
...
// //     services.filter(s => s.service !== undefined).map(s => s.service),
// //     [services]
// //   );
...
// //           time: data.time,
// //           customerName: data.customer_name,
// //           services: initialServices.map((service: { service: any; price: any; }) => ({
...
// //     newServices[index] = {
// //       ...services[index],
// //       service: masterService.name || masterService.service_name,
// //       // Keep existing price if already manually set, otherwise use default
// //       price: services[index].price ?? (masterService.price ? parseFloat(masterService.price) : undefined),
// //       isDropdownOpen: false,
// //       searchTerm: masterService.name || masterService.service_name,
// //       isManualEdit: false,
// //     };
...
// //       (service) =>
// //         (service.name || service.service_name).toLowerCase().includes(searchTerm.toLowerCase()) &&
// //         !selectedServiceNames.includes(service.name || service.service_name)
// //     );
// //   };
...
// //         setServiceValidationError(`Service is required for row ${index + 1}`);
// //         isValid = false;
// //       }
// //       if (service.price === undefined || isNaN(service.price) || service.price <= 0) {
// //         setServiceValidationError(`Valid price is required for row ${index + 1}`);
// //         isValid = false;
// //       }
// //     });
...
// //                 type="text"
// //                 placeholder="Car Reg"
// //                 className={`border ${errors.car ? 'border-red-500' : 'border-aclightash'} px-3 py-3 rounded bg-aclightash focus:outline-none`}
// //               />
// //               {errors.car && (
// //                 <span className="text-red-500 text-sm mt-1">
// //                   {errors.car.message}
...
// //                 type="date"
// //                 placeholder="Date"
// //                 className={`border ${errors.date ? 'border-red-500' : 'border-aclightash'} px-3 py-3 rounded bg-aclightash focus:outline-none`}
// //               />
// //               {errors.date && (
// //                 <span className="text-red-500 text-sm mt-1">
// //                   {errors.date.message}
...
// //                 type="text"
// //                 placeholder="Customer Name"
// //                 className={`border ${errors.customerName ? 'border-red-500' : 'border-aclightash'} px-3 py-3 rounded bg-aclightash focus:outline-none`}
// //               />
// //               {errors.customerName && (
// //                 <span className="text-red-500 text-sm mt-1">
// //                   {errors.customerName.message}
...
// //                 type="time"
// //                 placeholder="Time"
// //                 className={`border ${errors.time ? 'border-red-500' : 'border-aclightash'} px-3 py-3 rounded bg-aclightash focus:outline-none`}
// //               />
// //               {errors.time && (
// //                 <span className="text-red-500 text-sm mt-1">
// //                   {errors.time.message}
...
// //             <div className="text-red-500 mb-4 font-semibold">{serviceValidationError}</div>
// //           )}
// //           {deleteError && (
// //             <div className="text-red-500 mb-4 font-semibold">{deleteError}</div>
// //           )}
...
// //                           <input
// //                             type="number"
// //                             className={`w-full p-1 border-2 rounded text-right ${
// //                               errors.services?.[index]?.price ? "border-red-500" : "border-acgrey"
// //                             }`}
// //                             value={service.price ?? ''}
// //                             onChange={(e) => {
...
//       setIsLoading(false);
//     }
//   }, [id, reset, calculateActualTotal, navigate]);
...
//     };
//     fetchData();
//   }, [id, loadAppointmentData, loadServices, navigate]);
...
//       const payload = {
//         car_reg: (updatedFormData.car || "").trim(),
...
//       const response = await apiAxios.patch(`/api/appointments/update/${id}/`, payload);
...
//     }
//   }, [services, selectedCustomerType, includeVAT, id, closePopup, navigate]);
...
//                   <th className="p-2">Price(&pound;)</th>
//                 </tr>
//               </thead>
//               <tbody>
//                 {services.length > 0 ? (
...
//                                   >
//                                     <span>{masterService.name || masterService.service_name || 'Unnamed Service'}</span>
//                                     <span className="text-gray-600">${masterService.price}</span>
//                                   </div>
//                                 ))
//                               ) : (
...
//               className="bg-main text-white px-4 py-2 rounded hover:bg-white hover:text-main border hover:border-main"
//               href={`http://217.154.63.73:8000/api/quote/${id}/`}
//             >
//               Create Quote
//             </a>
//             <button
...
//             <a target="_blank" rel="noreferrer"
//               className="bg-main text-white px-4 py-2 rounded hover:bg-white hover:text-main border hover:border-main"
//               href={`http://217.154.63.73:8000/api/invoice/${id}/`}
//             >
//               Create Invoice
//             </a>
//           </div>
